...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `tescore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ tescore-node add wallet-service');
      console.log('    $ tescore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ tescore-node remove wallet-service');
      console.log('    $ tescore-node remove insight-api');
      console.log();
    });
